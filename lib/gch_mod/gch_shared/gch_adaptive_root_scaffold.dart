  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final destinations = [
      NavigationDestination(
        ...
        label: GchText.homePageTitle,
      ),
      NavigationDestination(
        icon: const Icon(Icons.filter_list),
        label: GchText.nodesPageTitle,
      ),
      NavigationDestination(
        icon: const Icon(Icons.edit),
        label: GchText.configPageTitle,
      ),
      NavigationDestination(
        icon: const Icon(Icons.settings),
        label: GchText.settingsPageTitle,
      ),
      NavigationDestination(
        icon: const Icon(Icons.description),
        label: GchText.logDataPageTitle,
      ),
      NavigationDestination(
        icon: const Icon(Icons.info),
        label: GchText.aboutPageTitle,
      ),
    ];
    ...
    return _CustomAdaptiveScaffold(
      ...
      drawerDestinationRange: (2, null),
      bottomDestinationRange: (0, 2),
      useBottomSheet: true,
      sidebarTrailing: null,
      body: navigator,
    );
  }
}
